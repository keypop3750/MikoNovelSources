package yokai.extension.novel.all.pt

import yokai.extension.novel.lib.*

/**
 * Source for MeioNovel (meionovel.com)
 * Portuguese (Brazilian) translated novels.
 */
class MeioNovel : NovelSource() {
    
    override val id: Long = 6300L
    override val name: String = "MeioNovel"
    override val baseUrl: String = "https://meionovel.com"
