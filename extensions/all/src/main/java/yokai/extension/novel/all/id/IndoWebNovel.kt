...
/**
 * Source for IndoWebNovel (indowebnovel.id)
 * Indonesian web novels.
 */
class IndoWebNovel : NovelSource() {
    
    override val id: Long = 6100L
    override val name: String = "IndoWebNovel"
    override val baseUrl: String = "https://indowebnovel.id"
